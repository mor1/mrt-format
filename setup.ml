...
(* OASIS_START *)
(* DO NOT EDIT (digest: 58ffc07c79dbdffc4e95d6f531390172) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("mrt", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("mrt", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "http://github.com/mor1/ocaml-mrt";
          synopsis = "MRT parsing";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mrt"; "Operators"; "Table"; "Bgp4mp"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mrt";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/mrt";
                      doc_title = "API reference for mrt";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "-(\136Úi¡\016\141?‹9\133 \022\\L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
