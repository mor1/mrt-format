...
(* OASIS_START *)
(* DO NOT EDIT (digest: 262a57ae5959a04af093a4f7eb76b2fb) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$omrt", ["test.mrtd"]))];
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "MRT parsers API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "omrt.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ê;\t9fo\027≥v«‰¸À\"µÓ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
